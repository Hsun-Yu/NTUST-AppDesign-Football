...
public class PlayerDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(playerStart == 1)
            ((TextView)findViewById(R.id.player_start_detail_view)).setText("Not Good");
        else if(playerStart == 2)
            ((TextView)findViewById(R.id.player_start_detail_view)).setText("Good");
        else if(playerStart == 3)
            ((TextView)findViewById(R.id.player_start_detail_view)).setText("Very Good");
    }
}
